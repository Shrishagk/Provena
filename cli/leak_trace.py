...
from identity.keyring import canonical_json, load_verified_keyring, unb64
...
def main() -> None:
    ...
    report = {"watermark_session_id": token, "recipient_id": recipient_id,
              ...
              "keyring_signature_valid": True, "recipient_ml_dsa_signature_valid": signature_valid,
              "document_ciphertext_binding_valid": document_binding_valid,
              "ledger_chain_and_quorum_valid": bool(ledger_quorum_valid),
              "verdict": "ATTRIBUTION VERIFIED" if signature_valid and document_binding_valid and ledger_quorum_valid else "ATTRIBUTION NOT VERIFIED"}
